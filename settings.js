  ...
  // Other
  global.ownername = 'ｉｄａｍｘｉｘｉツ' // Ganti Jadi Namamu
  global.owner = ['6285691890852','6285691890852','6285691890852'] // Kalo Mau Lebih Tambahin Aja
  global.ownernomer = '6285691890852' // Owner Utama Istilahnya
  global.botname = '𝚞𝚕𝚝𝚛𝚊𝚖𝚊𝚗𝚋𝚘𝚝𝚣' // Ganti Jadi Nama Botmu
  global.packname = 'Sticket By' // Sticker Weem
  global.author = 'ｉｄａｍｘｉｘｉツ' // Sticker Weem
  ...
  global.github = 'https://github.com/Idamxixi' // Ganti Sama Link Github Mu
  global.instagram = 'https://instagram.com/idam_unyi10' // Ganti Sama Link Ig mu
  ...
  botAdmin: '*Bot Bukan Admin Stress🗿*',
  owner: '*Lu Bukan Owner Gw 🗿*',
  group: '*Khusus Group 🗿*',
  private: '*Khusus Private Chat*',
  bot: '*Khusus Pengguna Nomer Bot*',
  wait: '*Waitt Tod Lagi Di Proses🗿🚬 ...*',
  done: '*Done Om🗿🚬*',
  }
